...
export const MOCK_PLAYERS: Player[] = [
  { 
    id: '1', name: 'C. Stroud', position: Position.QB, age: 24, overall: 91, schemeOvr: 94, morale: 95, fatigue: 98, archetype: 'Field General', personality: 'Leader', scheme: 'West Coast', developmentTrait: 'X-Factor', potential: 'X-Factor',
  ...
  { 
    id: '2', name: 'J. Mixon', position: Position.RB, age: 29, overall: 84, schemeOvr: 82, morale: 88, fatigue: 82, archetype: 'Power Back', personality: 'Workhorse', scheme: 'Zone', developmentTrait: 'Star', potential: 'Star',
  ...
  { 
    id: '3', name: 'N. Collins', position: Position.WR, age: 26, overall: 89, schemeOvr: 91, morale: 92, fatigue: 90, archetype: 'Deep Threat', personality: 'Normal', scheme: 'Vertical', developmentTrait: 'Superstar', potential: 'Superstar',
  ...
  { 
    id: '4', name: 'T. Dell', position: Position.WR, age: 25, overall: 83, schemeOvr: 85, morale: 85, fatigue: 94, archetype: 'Slot Specialist', personality: 'Normal', scheme: 'West Coast', developmentTrait: 'Star', potential: 'Superstar',
  ...
  { 
    id: '5', name: 'W. Anderson Jr.', position: Position.DL, age: 24, overall: 94, schemeOvr: 96, morale: 96, fatigue: 91, archetype: 'Speed Rusher', personality: 'Leader', scheme: '4-3 Under', developmentTrait: 'X-Factor', potential: 'X-Factor',
  ...
  { 
    id: '6', name: 'D. Stingley Jr.', position: Position.CB, age: 24, overall: 90, schemeOvr: 92, morale: 89, fatigue: 88, archetype: 'Man-to-Man', personality: 'Normal', scheme: 'Press Man', developmentTrait: 'Superstar', potential: 'X-Factor',
  ...
  { 
    id: '7', name: 'L. Tunsil', position: Position.OL, age: 31, overall: 92, schemeOvr: 92, morale: 90, fatigue: 85, archetype: 'Pass Protector', personality: 'Normal', scheme: 'Zone', developmentTrait: 'Star', potential: 'Star',
  ...
  {
    id: 'kc1', name: 'P. Mahomes', position: Position.QB, age: 30, overall: 99, schemeOvr: 99, morale: 98, fatigue: 95, archetype: 'Improviser', personality: 'Gunslinger', scheme: 'West Coast', developmentTrait: 'X-Factor', potential: 'X-Factor',
  ...
  {
    id: 'sf1', name: 'C. McCaffrey', position: Position.RB, age: 29, overall: 98, schemeOvr: 99, morale: 94, fatigue: 85, archetype: 'Receiving Back', personality: 'Ring Chaser', scheme: 'Zone', developmentTrait: 'X-Factor', potential: 'X-Factor',
  ...
  {
    id: 'bal1', name: 'L. Jackson', position: Position.QB, age: 29, overall: 97, schemeOvr: 95, morale: 96, fatigue: 92, archetype: 'Scrambler', personality: 'Leader', scheme: 'Spread', developmentTrait: 'X-Factor', potential: 'X-Factor',
  ...
  {
    id: 'phi1', name: 'A.J. Brown', position: Position.WR, age: 28, overall: 95, schemeOvr: 93, morale: 92, fatigue: 90, archetype: 'Physical Receiver', personality: 'Mercenary', scheme: 'Vertical', developmentTrait: 'Superstar', potential: 'Superstar',
  ...
  {
    id: 'det1', name: 'A. St. Brown', position: Position.WR, age: 26, overall: 94, schemeOvr: 96, morale: 95, fatigue: 94, archetype: 'Slot Specialist', personality: 'Workhorse', scheme: 'West Coast', developmentTrait: 'Superstar', potential: 'Superstar',
    stats: { gamesPlayed: 6, yards: 680, touchdowns: 6 },
  ...
  {
    id: 'fa1', name: 'Stefon Diggs', position: Position.WR, age: 32, overall: 88, schemeOvr: 88, morale: 75, fatigue: 100, archetype: 'Route Runner', personality: 'The Diva', scheme: 'Vertical', developmentTrait: 'Superstar', potential: 'Star',
  ...
  {
    id: 'fa2', name: 'Saquon Barkley', position: Position.RB, age: 29, overall: 90, schemeOvr: 92, morale: 80, fatigue: 100, archetype: 'Elusive Back', personality: 'Workhorse', scheme: 'Zone', developmentTrait: 'Superstar', potential: 'Superstar',
