...
import { AppView, DraftProspect, DraftPick, Scout, LeagueState, LeaguePhase, Player, Coach, TradeRecord, HallOfFamer } from './types';
  ...
  const renderView = () => {
    ...
    switch (currentView) {
      case AppView.DASHBOARD:
        return <Dashboard selectedTeamId={selectedTeamId} leaguePhase={leagueState.currentPhase} currentWeek={leagueState.week} teams={teams} allPlayers={allPlayers} schedule={SCHEDULE_2027} salaryCap={leagueState.salaryCap} />;
      case AppView.ROSTER:
